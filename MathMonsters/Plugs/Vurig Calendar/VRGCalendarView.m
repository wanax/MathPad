...
- (void)drawRect:(CGRect)rect
{
    ...
    for (int i =0; i<[weekdays count]; i++) {
        ...
        [weekdayValue drawInRect:CGRectMake(i*(kVRGCalendarViewDayWidth+2), 60, kVRGCalendarViewDayWidth+2, 20)
                 withAttributes:@{NSFontAttributeName:[UIFont fontWithName:@"Heiti SC" size:18.0], NSForegroundColorAttributeName:[UIColor orangeColor]}];
    }
...
//    NSLog(@"currentMonth month = %i day = %i, todaydate day = %i",[currentMonth month],[currentMonth day],[todayDate month]);
    ...
    for (int i=0; i<numBlocks; i++) {
        ...
        //[date drawInRect:CGRectMake(targetX+15, targetY+30, kVRGCalendarViewDayWidth, kVRGCalendarViewDayHeight)
                  //withAttributes:@{NSFontAttributeName:[UIFont fontWithName:@"Heiti SC" size:18.0]}];
    }
